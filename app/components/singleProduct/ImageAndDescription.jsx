...
const ImageAndDescription = () => {
  ...
  const product = ProductsData.find((p) => p.id === parseInt(id)) || null;
  ...
  const handleTouchEnd = (e) => {
    ...
    if (swipeDistance > 50) handleNextImage(1); // Swipe left
    else if (swipeDistance < -50) handlePrevImage(-1); // Swipe right
  };
